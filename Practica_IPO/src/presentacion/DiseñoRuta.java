...
import presentacion.DiseñoRuta.BtnAnotacionActionListener;
import presentacion.DiseñoRuta.BtnCargarMapaActionListener;
import presentacion.DiseñoRuta.BtnFinalActionListener;
import presentacion.DiseñoRuta.BtnRectanguloActionListener;
import presentacion.DiseñoRuta.BtnInicioActionListener;
import presentacion.DiseñoRuta.MiAreaDibujoMouseListener;
import presentacion.DiseñoRuta.MiAreaDibujoMouseMotionListener;

public class DiseñoRuta extends JPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DiseñoRuta window = new DiseñoRuta();
	...
	private void initialize() {
		...
		frame.getContentPane().setBounds(new Rectangle(0, 0, 700, 700));
		{
			...
			frame.getContentPane().add(toolBar, BorderLayout.NORTH);
			{
				...
				btnCargarMapa.setIcon(new ImageIcon(DiseñoRuta.class.getResource("/presentacion/cargarMapa.png")));
				toolBar.add(btnCargarMapa);
			}
			{
				btnInicio = new JButton("");
				btnInicio.addActionListener(new BtnInicioActionListener());
				btnInicio.setIcon(new ImageIcon(DiseñoRuta.class.getResource("/presentacion/home.png")));
				toolBar.add(btnInicio);
			}
			{
				btnFinal = new JButton("");
				btnFinal.addActionListener(new BtnFinalActionListener());
				btnFinal.setIcon(new ImageIcon(DiseñoRuta.class.getResource("/presentacion/final.png")));
				toolBar.add(btnFinal);
			}
			{
				btnRectangulo = new JButton("");
				btnRectangulo.addActionListener(new BtnRectanguloActionListener());
				btnRectangulo.setIcon(new ImageIcon(DiseñoRuta.class.getResource("/presentacion/rectangulo.png")));
			...
			}
			{
				...
				btnAnotacion
						.setIcon(new ImageIcon(DiseñoRuta.class.getResource("/presentacion/aniadirAnotacion.png")));
